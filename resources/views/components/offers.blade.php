        ...
        <div class="relative w-full h-[431px] bg-[black] rounded-[20px] shadow-lg overflow-hidden">
            ...
            <div class="flex items-center justify-between h-full px-12 md:px-16">
                ...
                <div class="flex-1 max-w-xl">
                    ...
                    {{-- CTA Button --}}
                    <button class="bg-[#F6433F] hover:bg-[#E63935] text-white font-semibold px-8 py-3 rounded-full text-[16px] transition-all duration-300 shadow-lg hover:shadow-xl">
                        Explore Now
                    </button>
                </div>
                ...
                <div class="hidden md:flex flex-1 items-center justify-end">
                    <div class="relative w-[506px] h-[461px]">
                        <img src="{{ asset('images/hand_holding_tickets.png') }}" 
                             alt="Hand holding coupon" 
