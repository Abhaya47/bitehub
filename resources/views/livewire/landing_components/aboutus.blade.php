    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="order-1 lg:order-2">
                <span
                    class="text-primary text-md font-semibold tracking-widest uppercase inline-block mb-4 text-red-500">
                    About Us
                </span>
                ...
                <div class="flex items-center gap-6">
                    <div
                        class="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-secondary flex-shrink-0 overflow-hidden border-1 border-primary">
                        <img src="{{ asset('images/no_avatar.jpg') }}" alt="Founder"
