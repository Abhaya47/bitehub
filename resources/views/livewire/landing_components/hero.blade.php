    ...
    <div class="container mx-auto relative h-full px-6 lg:px-12">
        <div class="flex flex-col lg:flex-row items-center justify-between min-h-[0px]">
            ...
            <div class="text-center lg:text-left max-w-full lg:max-w-[600px] z-10 py-12 lg:py-0">
                ...
                <!-- Welcome Text -->
                <h3
                    class="font-bold text-sm md:text-base lg:text-[19.27px] leading-none tracking-[1.71px] uppercase text-[#F9443D] mb-4">
                    WELCOME TO BITEHUB
                </h3>

                <!-- Main Heading -->
                <h1
                    class="font-normal text-3xl md:text-5xl lg:text-[55.83px] leading-snug lg:leading-[79px] text-[#000000] mb-5">
                ...
                <div class="flex flex-wrap justify-center lg:justify-start gap-4 md:gap-6">
                    ...
                    <!-- Learn More Button -->
                    <button
                        class="flex items-center justify-center gap-2 w-[140px] md:w-[154px] h-[48px] border border-[#A1A7AD] rounded-full hover:border-[#F9443D] transition-colors group">
                        <span
            ...
            <div class="hidden lg:block relative w-full lg:w-1/2 h-[600px] lg:h-[700px]">
                ...
                <div
                    class="absolute left-[110px] xl:left-[150px] top-[30px] w-[300px] md:w-[320px] xl:w-[360px] h-[520px] md:h-[560px] xl:h-[620px] rounded-[34px] rotate-[4.96deg] overflow-visible z-30 ">
                    <!-- soft radial glow behind the card -->
                    <div class="absolute -inset-3 rounded-[30px] pointer-events-none"
                        style="background: radial-gradient(closest-side, rgba(249,68,61,0.55), rgba(246,64,63,0.25) 40%, transparent 70%); filter: blur(28px); z-index:0;">
                    </div>
                    <div class="relative overflow-hidden rounded-[34px] animate-[bounce_8s_ease-in-out_infinite] "
                        style="z-index:10;">
                ...
                <div
                    class="absolute right-[-50px] top-[90px] w-[320px] md:w-[340px] xl:w-[380px] h-[420px] md:h-[460px] xl:h-[520px] rounded-[26px] -rotate-[7.55deg] overflow-visible z-20">
                    <div class="absolute -inset-3 rounded-[23px] pointer-events-none"
                        style="background: radial-gradient(closest-side, rgba(249,68,61,0.5), rgba(246,64,63,0.18) 40%, transparent 70%); filter: blur(30px); z-index:0;">
                    </div>
                    <div class="relative overflow-hidden rounded-[26px] animate-[bounce_8s_linear_infinite]"
                        style="z-index:10;">
