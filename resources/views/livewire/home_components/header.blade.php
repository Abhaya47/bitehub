<header x-data="{ atTop: true }" 
    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between h-20 px-6 lg:px-10">
        ...
        <div class="flex items-center space-x-4">
            ...
            {{-- Notifications --}}
            <button class="w-11 h-11 flex items-center justify-center rounded-full bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all text-[#0f172a]">
