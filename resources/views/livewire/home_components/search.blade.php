<div class="relative w-full max-w-2xl  sm:max-w-2xl md:max-w-4xl lg:max-w-2xl xl:max-w-sm">
    ...
    @if ($search !== '')
        <div
            class="absolute top-full left-0 w-full mt-2 flex flex-col rounded-xl bg-white/60 backdrop-blur-lg border border-white/40 shadow-2xl overflow-hidden z-50">
