<div class="w-full max-w-full mx-auto px-4 pt-32 pb-6">
    ...
    <div class="relative w-full h-[425.48px] mb-6">
        ...
        {{-- Left Arrow Button --}}
        <button
            class="carousel-btn-prev absolute left-[36.56px] top-1/2 -translate-y-1/2 w-[60.93px] h-[40px] bg-white rounded-lg flex items-center justify-center hover:bg-gray-100 transition-colors shadow-md z-10">
        ...
        {{-- Right Arrow Button --}}
        <button
            class="carousel-btn-next absolute right-[36.56px] top-1/2 -translate-y-1/2 w-[60.93px] h-[40px] bg-white rounded-lg flex items-center justify-center hover:bg-gray-100 transition-colors shadow-md z-10">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
