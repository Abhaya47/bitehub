<footer class="bg-[#F9413F] text-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            ...
            {{-- Column 1: About Us --}}
            <div>
                <h3 class="text-lg sm:text-[20px] font-bold mb-4">
                    About Us
                </h3>
                <p class="text-sm sm:text-[14px] leading-relaxed mb-4 sm:mb-6 text-white/90 text-justify">
                ...
                <a href = "{{ route('landing') }}">
                    <button
                        class="text-white font-bold text-sm sm:text-[14px] uppercase tracking-wide hover:underline transition-all">
                        READ MORE
                    </button>
                </a>
            </div>
            ...
            <div>
                ...
                <p class="text-sm sm:text-[14px] mb-4 sm:mb-6 leading-relaxed">
    ...
    <div class="border-t border-white/30">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                {{-- Copyright Text --}}
                <p class="text-sm sm:text-[14px] text-white/90">
