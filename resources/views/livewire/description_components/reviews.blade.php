        ...
        <div class="flex flex-col lg:flex-row items-center justify-center gap-[60px]">
            ...
            <div class="flex flex-col items-center w-[262px]">
                ...
                <p class="text-sm font-medium leading-4 text-[#5F5F5F] text-center">
                    Based on 200 reviews <a href="#" class="text-[#F6433F] hover:underline">Rate now</a>
                </p>
            </div>
            ...
            <div class="flex flex-col justify-center gap-8 flex-1 max-w-[985px]">
                ...
                <div class="flex items-center gap-3">
                    ...
                    {{-- Progress Bar --}}
                    <div class="relative flex-1 h-2.5 bg-[rgba(0,66,37,0.4)] rounded-[12px] overflow-hidden">
                        <div class="absolute top-0 left-0 h-full bg-[#F6433F] rounded-[12px]" style="width: 78.7%;">
                        </div>
                    </div>
