<div>
    <section class="bg-gray-50 bg-[url({{ asset('images/wave_grey_background.png') }})] bg-cover bg-invert rotate-180">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 rotate-180">
            <a href="/"
                class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white tracking-wider">
                BiteHUB
            </a>
            <div
                    ...
                    <form wire:submit.prevent="register" class="space-y-4 md:space-y-6" method="post">
                        ...
                        <div>
                            @if (session()->has('message'))
                                <div id="toast-simple"
                                    class="flex items-center w-full max-w-xs p-2 space-x-4 rtl:space-x-reverse text-red-500 bg-white divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow-sm dark:text-red-500 dark:accent-red-500 dark:bg-gray-800 border-2 border-red-700"
                                    role="alert">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-800  dark:hover:bg-purple-950 dark:focus:ring-primary-800">Create
                            an account</button>
