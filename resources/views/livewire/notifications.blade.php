            ...
            <div class="divide-y divide-gray-200">
                @if ($notifications->count() > 0)
                    @foreach ($notifications as $notificationRead)
                        <div class="px-6 py-4 hover:bg-gray-50 {{ !$notificationRead->is_read ? 'bg-blue-50' : '' }} transition-colors">
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <div class="flex items-center space-x-2 mb-2">
                                        <h3 class="font-semibold text-gray-900 {{ !$notificationRead->is_read ? 'font-bold' : '' }}">
