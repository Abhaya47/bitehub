    ...
    <div class="select-none relative">
        ...
        <div id="card-slider"
            ...
            <div
                ...
                <div class="absolute top-[29px] md:top-[35px] lg:top-[40px] left-[19px] md:left-[24px] lg:left-[28px]">
                    <h3
            ...
            <div
                ...
                <div class="absolute top-[25px] md:top-[30px] lg:top-[35px] left-[12px] md:left-[16px] lg:left-[20px]">
                    <h3
                        class="font-raleway font-bold text-[22px] md:text-[26px] lg:text-[30px] leading-[26px] md:leading-[30px] lg:leading-[35px] tracking-[0.03em] text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)]">
                        Veg
                    </h3>
    ...
    <div class="select-none relative">
        ...
        <div id="featured-slider"
            ...
            <div
                ...
                {{-- Discount Badge --}}
                <div class="absolute bottom-5 md:bottom-6 lg:bottom-7 left-[143px] md:left-[165px] lg:left-[189px]">
                    <span
                        class="font-medium text-[13px] md:text-[14px] lg:text-[15px] leading-4 tracking-wider text-[#252B5C]">Up
                        to 20% Off</span>
                </div>
